    ...
    return (
        ...
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <Link to='/' className="flex items-center">
                        <img src={Logo} className="mr-3 h-8" alt="Red Onion Logo" />
                    </Link>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a target={"_blank"} href="https://github.com/un-earthly" className="hover:underline">Alamin</a>. All Rights Reserved.
                </span>
